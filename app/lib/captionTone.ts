...
const CAPTIONS: Record<string, CaptionFn> = {
  ...
  "my-home-oneroom-first": () =>
    [
      ...
      "",
      "2040 1인 가구 40% 시대, 첫 목표가 '아파트 소유'일 필요 없어요!",
  ...
  "us-kr-rate-compare": () =>
    [
      ...
      "",
      "2040은 대출/전월세/투자 모두 '금리 방향' 먼저 체크!",
    ].join("\n"),

  "2040-retire-story": () =>
    [
      "2040, 은퇴까지 월 얼마 모아야 할까...?",
      "",
  ...
  "housing-policy-meeting": () =>
    [
      "국회 부동산 간담회, 2040한테 뭐가 중요한지 쉽게 정리!",
      "",
      "7,500건 의견 중 32%가 '공급', 25%가 '대출(금융)'",
      "2040한테 직결 -> DSR/청약/전세 정책!",
      "",
  ...
  "policy-dsr-story": () =>
    [
      "정부 DSR/주택정책 바뀐다... 2040 나한테 뭐가 달라져?",
      "",
